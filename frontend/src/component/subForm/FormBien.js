...
export default function FormBien({id}) {
    ...
    return (
        <>
            <button
            onClick={handleOpen}
            className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-700 hover:bg-green-600"
            >
            { id ? 'Modifier' : 'Crée'}
            </button>
            <Modal
