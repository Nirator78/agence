                            ...
                            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4" xs={4} key={item.id}>
                                <div className="px-6 py-4">
                                    ...
                                    <div className='flex'>
                                        ...
                                        <button className="flex py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-700 hover:bg-red-600" onClick={ async () => await RendezVousService.deleteRendezvous(item.id) &&  window.location.reload()}>
                                            Supprimer  
                                        </button> 
                                    </div>    
